...
注意：``audit_auth_groups`` 默认填 ``'14,15,3'`` (研发组长 14 → DBA 组长 15 → DBA 3)
...
8/18 用户截图确认: 134 dev 审批日志 "审批流程:研发组长>DBA组长>DBA",
auth_group 实际: 3=DBA, 13=研发, 14=研发组长, 15=DBA组长,
所以 ``'14,15,3'`` = 研发组长(14)→DBA组长(15)→DBA(3), 是对的。
"""
...
FALLBACK_FLOW_DESCRIPTION = (
    ...
    "audit_auth_groups 默认 '14,15,3' 表示研发组长(14)→DBA组长(15)→DBA(3) 3 级审批。"
