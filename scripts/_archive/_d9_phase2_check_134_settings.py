...
# -*- coding: utf-8 -*-
"""
D9 阶段 2: 134 dev settings.py 实际状态
"""
import io
import sys
import paramiko
...
CMDS = [
    'grep -n CUSTOM_DDL_SYNC /opt/archery/prod/archery/settings.py',
    'sed -n 418,440p /opt/archery/prod/archery/settings.py',
    'ls -la /opt/archery/prod/archery/',
]
