...
# -*- coding: utf-8 -*-
"""
D10 Case C hotfix: 推 sync_trigger.py 修 UnboundLocalError + kill gunicorn + 重测
"""
import io
import sys
import paramiko
...
REMOTE_CMDS = [
    ...
    # 验 sync_trigger 修后能 import
    'cd /opt/archery/prod && sudo -u archery venv/bin/python -c "from sql.extensions.ddl_sync.services.sync_trigger import _should_sync; print(\"_should_sync import OK\")"',
]
