...
# -*- coding: utf-8 -*-
"""
D11 hotfix #3: 推 pair_detail.html 修 block name (extra_js → js) + restart gunicorn
"""
import io
import sys
import paramiko
...
REMOTE_CMDS = [
    # 1. 备份
    'cp /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html.bak_20260902_1410',
    # 2. chown
    ...
    # 5. 验证 pair_detail.html 里 block js 真的有 script tag
    'grep -A 2 "block js" /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html',
    'echo "--- 验证 static 引用 ---"',
    'grep "static" /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html',
]
