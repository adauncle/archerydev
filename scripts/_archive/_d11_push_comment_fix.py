...
# -*- coding: utf-8 -*-
"""
D11 hotfix #5: 推 pair_detail.html 彻底清掉注释里的 {{% }} + restart gunicorn
"""
import io
import sys
import paramiko
...
REMOTE_CMDS = [
    'cp /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html /opt/archery/prod/sql/extensions/ddl_sync/templates/ddl_sync/pair_detail.html.bak_20260902_1420',
    ...
    'echo --- 134 dev pair_detail.html 所有 block ---',
