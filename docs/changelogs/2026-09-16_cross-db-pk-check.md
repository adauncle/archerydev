...
- **9/16 09:23 W3 跨库限制 + INSERT PK 冲突检测 (本 entry, A 严格, DBA 一条龙全包)**

## 下次推 prod checklist 必加 3 条 (W3 实战新发现)
