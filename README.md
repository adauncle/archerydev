...
> 上游 [Archery](https://github.com/hhyo/Archery) v1.14.0 不具备的、面向内部 DBA 实战场景的关键能力。
> 全部基于真实业务工单闭环（9/11-9/22 接龙 33+ commit），三段式演练（134 dev 端到端 + 110 prod + 业务方实测）后才上线。
...
详细设计 / commit 链路 / 演练 case 见 [`docs/reports/2026-09-18_月度DBA宣讲_6大功能.md`](docs/reports/2026-09-18_月度DBA宣讲_6大功能.md)。
